  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          <div
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border-0 group-data-[variant=floating]:shadow-lg"
            data-sidebar="sidebar"
          >
            {children}
          </div>
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      {showIcon && (
        <div
          className="size-4 animate-pulse rounded-md bg-sidebar-accent"
          data-sidebar="menu-skeleton-icon"
        />
      )}
      <div
        className="h-4 max-w-[var(--skeleton-width)] flex-1 animate-pulse rounded bg-sidebar-accent"
